...
| test/presentation/rules/rule_editor_page_test.dart | Case 选择、上下文记忆与只读测试回归 |
| test/domain/rules/editor/rule_visual_renderer_test.dart | 复杂 AST、动态对象、Tag 文案与语义 round-trip 回归 |
