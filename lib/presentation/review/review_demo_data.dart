...
abstract final class ReviewDemoData {
  ...
  static HexagramCase hexagramCase() => HexagramCase(
    ...
    ruleContext: RuleExecutionContext(const [RuleVersionRef('sys.default', 1)]),
  );
  ...
  static ReviewTraditionalProfile profile() => const ReviewTraditionalProfile(
    ...
    shenShaItems: [
      ...
      ReviewShenShaItem(name: '天禄', value: '巳'),
      ReviewShenShaItem(name: '谋星', value: '未'),
      ReviewShenShaItem(name: '往亡', value: '戌'),
    ],
    yearPillar: '丙午年',
    yearNaYin: '天河水',
    monthPillar: '丙申月',
