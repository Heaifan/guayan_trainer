/// 六十四卦名真源表。
///
/// 键 = 上卦名 + 下卦名（如「乾巽」= 上乾下巽 → 天风姤）。
/// 仅作结构 → 名称的查表输出；禁止按中文名反解卦象。
library;

import '../trigram.dart';

const Map<String, String> hexagramNames = {
  // 上乾
...
/// 按上下卦查卦名。
String hexagramName(Trigram upper, Trigram lower) =>
    hexagramNames['${upper.name}${lower.name}'] ??
    (throw ArgumentError('六十四卦名表缺失：上${upper.name}下${lower.name}'));
