...
abstract final class RelationProjection {
  ...
  static RelationRecord _project(RelationInstance instance) {
    ...
    return RelationRecord.relation(
      ...
      title: '${instance.type.displayName}：${_label(instance.source)}'
          '${_arrow(instance)}${_label(instance.target)}',
      subtitle: '${instance.type.displayName} · ${_label(instance.source)} / '
  ...
  static String _category(RelationInstance instance) => switch (instance.type) {
    RelationType.sheng || RelationType.ke || RelationType.huiTouSheng ||
  ...
  static String _position(int position) => const ['初爻', '二爻', '三爻', '四爻', '五爻', '上爻'][position - 1];
